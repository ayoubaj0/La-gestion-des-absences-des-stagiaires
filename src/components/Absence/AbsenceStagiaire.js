...
function AbsenceStagiaire() {
  ...
  return (
    ...
    <div style={{ width: "74%", float: "right" }}>
      <h2>Filter stagiaire statistiques : </h2>
      ...
      <i class="fa fa-download btn btn-primary" aria-hidden="true">
        <ReactHTMLTableToExcel
          ...
          table="absences-stagiaire"
          filename="absences-stagiaire"
          sheet="absences-stagiaire"
          ...
          {absencesByStagiaire.map((absence) => (
            <tr key={absence.idstg}>
              ...
              <td>
                ...
                <button onClick={() => toggleTable(absence.namestg)}>
                  {showTable ? (
          ...
          <tbody>
            {filteredAbsences.map((absence) => (
              <tr key={absence.id}>
                ...
                <td>
                  {absence.hours} - {parseInt(absence.hours) + 2}
                </td>
